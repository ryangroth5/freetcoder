...
const SERVER_FIELDS: {
  ...
  { name: 'llm_fallback_model', label: 'Fallback model', kind: 'text',
    hint: 'Same endpoint; tried once when the main model stalls or fails. Empty disables it.' },
  { name: 'llm_first_token_s', label: 'First-token deadline (seconds)', kind: 'number',
    min: 1, max: 600, hint: 'No tokens by then and the call is abandoned early' },
  { name: 'llm_idle_s', label: 'Mid-reply silence allowed (seconds)', kind: 'number',
    min: 1, max: 600 },
  { name: 'llm_reasoning_effort', label: 'Thinking', kind: 'choice',
    options: [
      { value: 'default', label: "Model's default" },
      { value: 'none', label: 'None' },
      { value: 'low', label: 'Low' },
      { value: 'medium', label: 'Medium' },
      { value: 'high', label: 'High' },
    ],
    hint: 'Less is faster and cheaper, and may cost questions. Not every model honours it.' },
